...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                         ...
                                         <td style="padding-left: 5px; font-weight: bold">
                                        <asp:CheckBox ID="chkGratuito" runat="server" Text="Gratuito" Font-Bold="True" 
                                         onclick="F_ValidarGratuito(this.id);"/>
                                         </td>
                                        ...
                                        <td>
                                            <div id="div_CajaFisica">
                                                <asp:DropDownList ID="ddlCajaFisica" runat="server" Font-Names="Arial" Font-Bold="True"
                ...
                <asp:GridView ID="grvDetalleArticulo" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producto">
                            <ItemStyle HorizontalAlign="Left" />
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblProducto"  CssClass="detallesart2" Text='<%# Bind("Producto") %>'></asp:Label>
    ...
    <input id="hfCodAlmacen" type="hidden" value="0" />
       ...
       <input id="hfSubtotal" type="hidden" value="0" />
</asp:Content>
