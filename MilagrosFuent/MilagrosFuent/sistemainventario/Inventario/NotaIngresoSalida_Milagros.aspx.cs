...
{
    public partial class NotaIngresoSalida_Milagros : System.Web.UI.Page
    {
        ...
        public String F_Observacion_NET(String arg)
        {
            ...
            try
            {
                ...
                grvDetalle.DataSource = objOperacion.F_NotaIngresoSalidaCab_OBSERVACION(objEntidad);
                grvDetalle.DataBind();
