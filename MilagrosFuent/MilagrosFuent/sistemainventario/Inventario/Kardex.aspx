            ...
            <Columns>
               <asp:TemplateField HeaderText="A">
                ...
                <asp:TemplateField HeaderText="ID">
                    ...
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblcodigo" Text='<%# Bind("Codigo") %>'  CssClass="detallesart2"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:BoundField DataField="FechaAnexo" HeaderText="Fecha Anexo">
                    ...
                    <ItemStyle HorizontalAlign="Center" />
                     ...
                     <asp:TemplateField HeaderText="VV">
                    <HeaderStyle HorizontalAlign="Center" />
                  ...
                  <asp:TemplateField HeaderText="VVs">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblCostoS" Text='<%# Bind("CostoS") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="UCSoles/C">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblCostoSoles" Text='<%# Bind("CostoSoles") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                    <asp:TemplateField HeaderText="UCDolares/S">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblCOstoDOLARES" Text='<%# Bind("COstoDOLARES") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                 <asp:TemplateField HeaderText="UBsoles">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblUBsoles" Text='<%# Bind("UBsoles") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                     <asp:TemplateField HeaderText="UBDolares">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Right" />
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblUBDolares" Text='<%# Bind("UBDolares") %>' CssClass="detallesart"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
