            ...
            <div class="ui-jqgrid ui-widget ui-widget-content ui-corner-all">
                ...
                <div>
                    ...
                    <table>
                            ...
                            <td style="padding-left: 4px;" >
                                <asp:TextBox ID="txtCelular" runat="server" Width="100px" Font-Names="Arial"
                                    ForeColor="Blue" Font-Bold="True"></asp:TextBox>
                            </td>
                                                </tr>
                                            </table>
                          ...
                          <asp:TemplateField HeaderText="ST PDF">
                            <ItemTemplate>
                                <asp:ImageButton runat="server" ID="imgStickerPDF" ImageUrl="~/Asset/images/pdf.png"
                                    ToolTip="VER Sticker" OnClientClick="F_ImprimirFacturaHTML_STICKER(undefined,this,'imgStickerPDF','PDF'); return false;" />
                            </ItemTemplate>
                        </asp:TemplateField>
