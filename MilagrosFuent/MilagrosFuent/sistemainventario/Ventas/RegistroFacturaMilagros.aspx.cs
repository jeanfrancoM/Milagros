...
{
    public partial class RegistroFacturaMilagros : System.Web.UI.Page
    {
        ...
        private void P_LlenarGridEmpresa_Almacenes()
        {
        ...
        /// <summary>
        /// Agrega al termporal la NOTA DE PEDIDO, y construye la grilla.
        /// </summary>
        ...
        //la utilizare tanto para nv como para ct
        ...
        protected void grvConsulta_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                CheckBox chkImprimir = null;
                ImageButton btnImprimir = null;
                ...
                chkImprimir = (CheckBox)(e.Row.FindControl("chkEliminar"));
                btnImprimir = (ImageButton)(e.Row.FindControl("imgPdfantiguo"));
                if (lblCodigo.Text != "")
                {
                    ...
                    if (lblNumero.Text.Substring(0, 1) == "F" | lblNumero.Text.Substring(0, 1) == "B")
                    {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            str_resultado =
                ...
                + "~" +
                str_ddlImpresoraNotaPedido_html
                + "~" +
        ...
        public String F_Mostrar_Correlativo_NET(String arg)
        {
            ...
            try
            {
                ...
                int_resultado_operacion = 1;
                str_mensaje_operacion = "Se obtuvo el correlativo";
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro,
            ...
            ref DropDownList ddl_comboalmacenfisico, ref DropDownList ddl_impresoranotapedido)
        {
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 CodControlInternoAlmacenCab)
        {
            ...
            try { objEntidad.CodTransportista = Convert.ToInt32(objTablaFiltro["Filtro_CodTransportista"]); } catch (Exception exxx) { objEntidad.CodTransportista = 0; } 
