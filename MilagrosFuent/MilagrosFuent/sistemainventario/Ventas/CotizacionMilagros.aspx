                ...
                <asp:GridView ID="grvConsulta" runat="server" AutoGenerateColumns="False" border="0"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Estado" HeaderStyle-HorizontalAlign="Center">
                         ...
                         <asp:TemplateField HeaderText="Doc.Adjunto" ItemStyle-HorizontalAlign="Center">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="lblFactura" Text='<%# Bind("Factura") %>' value="0"></asp:Label>                                 
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
                ...
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtArticulo" runat="server" Width="550px" Font-Names="Arial" ForeColor="Blue"
                                    Font-Bold="True"></asp:TextBox>
                            </td>
