    ...
    public partial class RegistroFacturaMultipleMilagros : System.Web.UI.Page
    {
        ...
        public string F_Consulta_Series_Net(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Serie(CodTipoDoc, codSed,CodTipoDoc, ref ddlSerie, ref ddlSerieConsulta, ref ddlSerieGuia);
        ...
        public String F_ObtenerDireccionCliente_Net(String arg)
        {
            ...
            try
            {
                ...
                ddlDireccionTransportista.DataSource = dtTabla;
                ddlDireccionTransportista.DataTextField = "DireccionTransportista";
                ddlDireccionTransportista.DataValueField = "CodDireccionTransportista";
                ddlDireccionTransportista.DataBind();
        ...
        public void P_Controles_Serie(int codEmpresa, int codSede, int CodTipoDoc, ref DropDownList ddl_comboserie, ref DropDownList ddl_comboserieconsulta, ref DropDownList ddl_comboguia)
        {
        ...
        public String F_Controles_Inicializar_NET(String arg)
        {
            ...
            try
            {
                ...
                P_Controles_Inicializar(obj_parametros, ref ddlFormaPago, ref ddlMoneda, ref ddlIgv, ref str_direccion,
                      ref ddlVendedorComision, ref ddlAlmacenFisico, ref ddlTipoDoc, ref ddlTipoDocConsulta);
        ...
        public void P_Controles_Inicializar(Hashtable objTablaFiltro,ref DropDownList ddl_comboformapago, ref DropDownList ddl_combomoneda,
            ...
            ref DropDownList ddl_combotipodoc, ref DropDownList ddl_combotipodocconsulta)
        {
            DataTable dta_consulta = null;
        ...
        public void P_GrabarDocumento(Hashtable objTablaFiltro, ref String MsgError, ref Int32 Codigo, ref Int32 CodControlInternoAlmacenCab)
        {
            ...
            objEntidad.NroRucTranspostista = Convert.ToString(objTablaFiltro["Filtro_NroRucTrasnportista"]);
            ...
            if (objEntidad.MsgError == "")
            {
                ...
                if (objEntidad.MsgError == "Se Grabo Correctamente")
                {
                    ...
                    {
                        if ((objEntidad.CodFormaPago == 1 | objEntidad.CodFormaPago == 6 | objEntidad.CodFormaPago == 15 | objEntidad.CodFormaPago == 16
                            | objEntidad.CodFormaPago == 17 | objEntidad.CodFormaPago == 18 | objEntidad.CodFormaPago == 19) & objEntidad.CodTipoDoc == 16)
                            //| objEntidad.CodTipoDoc == 1 | objEntidad.CodTipoDoc == 2 )
                        {
