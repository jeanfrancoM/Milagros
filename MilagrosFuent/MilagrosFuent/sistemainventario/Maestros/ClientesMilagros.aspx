<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ClientesMilagros.aspx.cs" Inherits="SistemaInventario.Maestros.ClientesMilagros" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript" src="ClientesMilagros.js" charset="UTF-8"></script>
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="padding-left: 8px; font-weight: bold; display:none">
                                            Letra
                                        </td>
                        ...
                        <tr>
                         ...
                         <td style="font-weight: bold;">
                            ...
                            <td style="padding-left: 4px;">
                                <div id="div_tipoimpuesto">
                                    <asp:DropDownList ID="ddlTipoImpuesto" runat="server" Font-Names="Arial" Width="88"
                    ...
                    <Columns>
                       ...
                       <asp:TemplateField HeaderText="RUC" HeaderStyle-HorizontalAlign="Center">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:HiddenField ID="hfFlagIncluyeIgv" runat="server" Value='<%# Bind("FlagIncluyeIgv") %>' />
                            </ItemTemplate>
                        </asp:TemplateField>
            ...
            <div class="ui-jqdialog-content">
                <table cellpadding="0" cellspacing="0" class="form-inputs">
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 4px;">
                            <div id="div_tipoimpuesto_edicion">
                                <asp:DropDownList ID="ddlTipoImpuestoEdicion" runat="server" Font-Names="Arial" Width="228"
                                    ForeColor="Blue" Font-Bold="True">
                                </asp:DropDownList>
                            </div>
                        </td>
                    ...
                    <div id="div_Direccion">
                        <asp:GridView ID="grvDireccion" runat="server" AutoGenerateColumns="False" border="0"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Celular 1" HeaderStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblCelular1" Text='<%# Bind("Celular1") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Celular 2" HeaderStyle-HorizontalAlign="Left">
                                    <ItemStyle HorizontalAlign="Left" />
                                    <ItemTemplate>
