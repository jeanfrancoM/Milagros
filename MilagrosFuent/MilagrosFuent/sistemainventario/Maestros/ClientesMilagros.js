...
var CodigoInterno = 1; /// EXCLUSIVIDAD DE LA PAGINA
...
$(document).ready(function () {
    ...
    $('#MainContent_txtcelular1').css('background', '#FFFFE0');
    $('#MainContent_txtcelular2').css('background', '#FFFFE0');
    ...
    $('#MainContent_txtCelularEdicion1').css('background', '#FFFFE0');
    $('#MainContent_txtCelularEdicion2').css('background', '#FFFFE0');
            ...
            (
                ...
                function (result) {
                    ...
                    if (str_resultado_operacion == "1") {
                        ...
                        F_Update_Division_HTML('div_tipoimpuesto', result.split('~')[12]);
                        F_Update_Division_HTML('div_tipoimpuesto_edicion', result.split('~')[13]);
                        ...
                        $('#MainContent_ddlRutaEdicion').val(0);
                        ...
                        $('#MainContent_ddlTipoImpuesto').css('background', '#FFFFE0');
                        $('#MainContent_ddlTipoImpuestoEdicion').css('background', '#FFFFE0');
...
function F_GrabarDocumento() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_FlagIncluyeIgv: $(Contenedor + 'ddlTipoImpuesto').val()
        };
        ...
        F_GrabarDocumento_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                if (str_mensaje_operacion == 'Se grabo correctamente') {
                    ...
                    $(Contenedor + 'ddlTipoImpuesto').val('0');
    ...
    try {
        ...
        F_Buscar_NET(arg, function (result) {
            ...
            if (str_resultado_operacion == "1") {
                ...
                $('#lblNumeroConsulta').text(F_Numerar_Grilla("grvConsulta", 'hfcodigo')); 
...
function F_EditarRegistro(Fila) {
    ...
    try {
        ...
        var hfFlagIncluyeIgv = '#' + imgID.replace('imgEditarRegistro', 'hfFlagIncluyeIgv');
        ...
        $('#hfcodigo').val($(lblcodigo_grilla).val());
        ...
        $(Cuerpo + 'ddlTipoImpuestoEdicion').val($(hfFlagIncluyeIgv).val());
...
function F_EdicionRegistro() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_FlagIncluyeIgv: $(Contenedor + 'ddlTipoImpuestoEdicion').val()
        };
...
//            Cadena = Cadena + '<p></p>' + 'Descuento 4';
        ...
        if ($(Cuerpo + 'ddlTipoImpuestoEdicion').val() === null)
            Cadena = Cadena + '<p></p>' + "Categoria";

        if ($(Cuerpo + 'ddlTipoImpuestoEdicion').val() === '0')
            Cadena = Cadena + '<p></p>' + "Categoria";
...
function F_Direccion(Fila) {
    ...
    var Cuerpo = '#MainContent_';
    if (F_PermisoOpcion(CodigoMenu, 777107, '') === "0") return false; //Entra a /Scripts/Utilitarios.js.F_PermisosOpcion para mas informac
    try {
        var objParams = {
...
function F_GrabarDireccion() {
    ...
    try {
        ...
        var objParams = {
            ...
            Filtro_Celular1: $(Contenedor + 'txtcelular1').val(),
            Filtro_Celular2: $(Contenedor + 'txtcelular2').val()
        };
...
function F_EditarRegistroDireccion(Fila) {
    ...
    try {
        ...
        var lblCelular1 = '#' + imgID.replace('imgEditarRegistro', 'lblCelular1');
        var lblCelular2 = '#' + imgID.replace('imgEditarRegistro', 'lblCelular2');
        ...
        $(Cuerpo + 'txtCelularEdicion1').val($(lblCelular1).text());
        $(Cuerpo + 'txtCelularEdicion2').val($(lblCelular2).text());
...
function F_GrabarDireccionMultiple() {
    try {
        ...
        var objParams = {
            ...
            Filtro_Celular1: $(Contenedor + 'txtCelularEdicion1').val(),
            Filtro_Celular2: $(Contenedor + 'txtCelularEdicion2').val()
        };
